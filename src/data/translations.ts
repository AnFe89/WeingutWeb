...
export const translations = {
  DE: {
    ...
    features: {
      f1_title: "Winzer*in in 7 Tagen",
      f1_sub: "Begleitet durchs Weinjahr",
      f1_cards: [
        "Januar: Fachgerechter Rebschnitt", 
        "April: Bodenbewirtschaftung", 
        "Mai/Juni: Laubwandmanagement",
        "Juli: Qualitätsfördernde Maßnahmen",
        "Oktober: Traubenernte",
        "Dezember: Jungweinprobe & Filtration",
        "April: Winzerabend & Zertifikat"
      ],
      f2_title: "Ökologie",
      ...
      f3_counter_sub: "(>25% unserer Weinbergsfläche)"
    },
    philosophy: {
    ...
    protocol_tag: "WEINBAU PHILOSOPHIE",
    protocol: [
      {
        step: "01",
    ...
    collection: {
      title: "Die Projekte",
      sub: "Aktiv mit dabei sein",
      c1_top: "Schenken",
      c1_title: "Rebstock-Patenschaft",
      c1_desc: "Der Klassiker im Rödchen oder exklusiv in der Steillage aus unserem Wein-Wald.",
      c1_price: "ab 75,00€",
      c2_top: "Lernen",
      c2_title: "Winzer*in in 7 Tagen",
      c2_desc: "7 Module begleitet durchs Weinjahr. Rebschnitt, Ernte & Zertifikat.",
      c2_price: "279,00€",
      c3_top: "Pionierarbeit",
      c3_title: "PiWi Jung-Reben",
      c3_desc: "Begleiten Sie 3 Jahre einen ganz besonderen Sauvitage Weinberg bis zum 1. Ertrag.",
      c3_price: "auf Anfrage",
      cta: "MEHR ERFAHREN"
    },
    footer: {
    ...
    shop: {
      title: "Online Shop",
      sub: "Bio-Weine aus Martinsthal",
      filterAll: "Alle Weine",
      addToCart: "In den Warenkorb",
      emptyState: "Lade Weine..."
    }
  },
  EN: {
    nav: {
    ...
    features: {
      f1_title: "Winemaker in 7 Days",
      f1_sub: "Guided through the year",
      f1_cards: [
        "January: Professional Pruning", 
        "April: Soil Management", 
        "May/June: Canopy Management",
        "July: Promoting Quality",
        "October: Grape Harvest",
        "December: Young Wine Tasting",
        "April: Winemaker Evening & Certificate"
      ],
      f2_title: "Ecology",
      ...
      f3_counter_sub: "(>25% of our vineyard area)"
    },
    philosophy: {
      pre: "Our Philosophy",
    ...
    protocol_tag: "VITICULTURE PHILOSOPHY",
    protocol: [
      {
        step: "01",
    ...
    collection: {
      title: "The Projects",
      sub: "Be visibly active",
      c1_top: "Gift",
      c1_title: "Vine Sponsorship",
      c1_desc: "The classic in Rödchen or exclusively in the steep slopes of our wine-forest.",
      c1_price: "from 75.00€",
      c2_top: "Learn",
      c2_title: "Winemaker in 7 Days",
      c2_desc: "7 modules guided through the wine year. Pruning, harvest & certificate.",
      c2_price: "279.00€",
      c3_top: "Pioneering",
      c3_title: "PiWi Young Vines",
      c3_desc: "Accompany a very special Sauvitage vineyard for 3 years until the 1st yield.",
      c3_price: "on request",
      cta: "LEARN MORE"
    },
    footer: {
    ...
    shop: {
      title: "Online Store",
      sub: "Organic Wines from Martinsthal",
      filterAll: "All Wines",
      addToCart: "Add to Cart",
      emptyState: "Loading wines..."
    }
  }
};
